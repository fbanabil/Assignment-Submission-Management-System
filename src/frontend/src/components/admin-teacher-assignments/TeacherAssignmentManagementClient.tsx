        ...
        <header className="overflow-hidden rounded-4xl border border-white/70 bg-(--color-surface) px-6 py-6 shadow-[0_24px_80px_rgba(15,23,42,0.12)] backdrop-blur sm:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl space-y-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/15 bg-blue-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-blue-700">
                Teacher Assignments
              </div>
              <div>
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm">
              ...
              >
                <span className="text-base font-bold">+</span> Assign Teacher
              </button>
              <Link
