        ...
        <header className="overflow-hidden rounded-4xl border border-white/70 bg-(--color-surface) px-6 py-6 shadow-[0_24px_80px_rgba(15,23,42,0.12)] backdrop-blur sm:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl space-y-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-purple-500/20 bg-purple-500/10 px-3.5 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-purple-700">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-(--color-muted) sm:text-base">
                  Manage academic subjects, course codes, and map subjects to assigned class sections across terms.
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5">
                  <select
                    ...
                    className="w-full rounded-2xl border border-slate-200 bg-white/80 px-3 py-2 text-sm font-medium text-foreground focus:border-purple-500 focus:outline-none transition shadow-2xs"
                  >
